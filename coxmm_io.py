...
class COXPHMM(IO):
	...
	def l_1(self, tau):
		...
		#print(tau)
		#print('u')
		#print(theta[self.M:(self.M+10)])
		#print('siu')
		#print(grm_u[0:10]/tau)
		del grm
	...
	def l_1_deriv(self, tau):
		...
		if self.M > 0:
			...
			#print('V[self.M:(self.M+5), 0:self.M]')
			#print(V[self.M:(self.M+5), 0:self.M])
			#s[one] -- X^T(d - WMA1)
	...
	def marg_loglike(self, tau):	
		...
		while (run == 0 or diff_loglike > eps) and run < max_runs:
			...
			#print(update[0:5])
			#print('update u')
			#print(update[self.M:(self.M+5)])
			del V,s
			theta = np.memmap(path.join(self.temp, self.theta), dtype='float64', mode='r+', shape=(self.N+self.M))
			#print('theta: beta')
			#print(theta[0:5])
			#print('theta: u')
			#print(theta[self.M:(self.M+5)])
			theta[:] += update
			#print('new theta: beta')
			#print(theta[0:5])
			#print('new theta: u')
			#print(theta[self.M:(self.M+5)])
