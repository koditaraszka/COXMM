...
d_plot = ggplot(neworg, aes(x=Numeric, y=d, ymin = d - d_se, 
  ...
  annotate("text", x = 0.67, y = 0.7, label = label1, size = 2.5) + scale_color_discrete(labels = unname(TeX(c("$h^2$", "$\\sigma_g^2$"))))
...
concord_plot = ggplot(neworg, aes(x=Numeric, y=concord, ymin = concord - concord_se, 
  ...
  annotate("text", x = 0.67, y = 0.615, label = label1, size = 2.5) + scale_color_discrete(labels = unname(TeX(c("$h^2$", "$\\sigma_g^2$"))))
...
r2ko_plot = ggplot(neworg, aes(x=Numeric, y=r2_ko, ymin = r2_ko - r2_ko_se, 
  ...
  annotate("text", x = 0.73, y = 0.075, label = label1, size = 2.5) + scale_color_discrete(labels = unname(TeX(c("$h^2$", "$\\sigma_g^2$"))))
...
r2n_plot = ggplot(neworg, aes(x=Numeric, y=r2_n, ymin = r2_n - r2_n_se, 
  ...
  annotate("text", x = 0.73, y = 0.02, label = label1, size = 2.5) + scale_color_discrete(labels = unname(TeX(c("$h^2$", "$\\sigma_g^2$"))))
...
extend1
ggsave("~/Desktop/Heritability/tables_figures/SuppFig1/SuppFig1.png", plot = supp_pseudo, width = 2400, height = 2400, units = "px", dpi = 300)
```
